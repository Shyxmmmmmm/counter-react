...
const Counter = () => {
    ...
    return (
        <div className='flex justify-center h-[475px] lg:h-[440px]'>
            <div className='bg-white mt-10 lg:w-[50%] md:w-[50%] w-[65%] p-10 rounded-2xl'>
                ...
                <span className={`flex  justify-center items-center mb-5 ${number === 0 ? "text-red-500" : "text-green-500"
                    }`}>{number === 0 ? "Minimum Limit Reached" : "Dashboard Active"}</span>
